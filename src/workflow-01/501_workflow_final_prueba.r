...
ZZ_final_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z871_ZZ_final_semillerio.r"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_final_prueba", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_final_prueba", "DT0001_final_prueba" )

  DR_drifting_guantesblancos( "DR0001_final_prueba", "CA0001_final_prueba" )
  FE_historia_guantesblancos( "FE0001_final_prueba", "DR0001_final_prueba" )

  TS_strategy_guantesblancos_202109( "TS0001_final_prueba", "FE0001_final_prueba" )

  HT_tuning_guantesblancos( "HT0001_final_prueba", "TS0001_final_prueba" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0001_final_prueba", c("HT0001_final_prueba","TS0001_final_prueba") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_final_prueba", "FE0001_final_prueba" )

  HT_tuning_guantesblancos( "HT0002_final_prueba", "TS0002_final_prueba" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_final_prueba", c("HT0002_final_prueba", "TS0002_final_prueba") )
...
corrida_guantesblancos_202109( "gb01_final_prueba" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_final_prueba" )
