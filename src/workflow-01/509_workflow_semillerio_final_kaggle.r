...
TS_strategy_baseline_202109 <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/z551_TS_training_strategy_final.r"
...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_baseline( "DT0001-final", "competencia_2024.csv.gz")
  CA_catastrophe_baseline( "CA0001-final", "DT0001-final" )

  DR_drifting_baseline( "DR0001-final", "CA0001-final" )
  FE_historia_baseline( "FE0001-final", "DR0001-final" )

  TS_strategy_baseline_202109( "TS0001-final", "FE0001-final" )

  HT_tuning_baseline( "HT0001-final", "TS0001-final" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-final1", c("HT0001-final","TS0001-final") )
...
corrida_baseline_semillerio_202109( "basem01_final" )
