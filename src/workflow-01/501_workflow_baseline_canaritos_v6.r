...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT0001_canarito_v6", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA0001_canarito_v6", "DT0001_canarito_v6" )

  DR_drifting_guantesblancos( "DR0001_canarito_v6", "CA0001_canarito_v6" )
  FE_historia_guantesblancos( "FE0001_canarito_v6", "DR0001_canarito_v6" )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS0002_canarito_v6", "FE0001_canarito_v6" )

  HT_tuning_guantesblancos( "HT0002_canarito_v6", "TS0002_canarito_v6" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ0002_canarito_v6", c("HT0002_canarito_v6", "TS0002_canarito_v6") )
...
corrida_guantesblancos_202109( "gb01_canarito_v6" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "gb02_canarito_v6" )
