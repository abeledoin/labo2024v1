...
setwd("/Users/inabeledo/Documents/laboratorio2024/labo2024v1") # Establezco el Working Directory
getwd()

# cargo el dataset
dataset <- fread("/Users/inabeledo/Documents/laboratorio2024/datasets/dataset_pequeno.csv")
...
fwrite(dapply[, list(numero_de_cliente, Predicted)],
        file = "./exp/KA2001/K101_001_rank_100_binario.csv",
        sep = ","
)