...
PARAM$finalmodel$num_iterations <- 1593
PARAM$finalmodel$learning_rate <- 0.01001869187
PARAM$finalmodel$feature_fraction <- 0.2075080266
PARAM$finalmodel$min_data_in_leaf <- 1325
PARAM$finalmodel$num_leaves <- 813
